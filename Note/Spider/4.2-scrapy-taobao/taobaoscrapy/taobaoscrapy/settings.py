...
DOWNLOADER_MIDDLEWARES = {
   'taobaoscrapy.middlewares.TaobaoscrapyDownloaderMiddleware': 543,
   'taobaoscrapy.middlewares.ProxyDownloaderMiddleware': 200,
   'taobaoscrapy.middlewares.RandomUserAgent': 100,
}
...
ITEM_PIPELINES = {
   'taobaoscrapy.pipelines.TaobaoscrapyHandleItemPipeline': 200,
